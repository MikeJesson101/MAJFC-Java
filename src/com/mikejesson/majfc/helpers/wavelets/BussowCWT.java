...
public class BussowCWT implements Serializable{  
    /**
	 * 
	 */
	private double[][] Re;  
    ...
    public BussowCWT(double[] y){  
           this(y,y.length,(double) y.length/4,100,"log",8,3);  
        }     
    public BussowCWT(double[] y,int fs){  
           this(y,fs,(double) fs/4,100,"log",8,3);  
        }     
    public BussowCWT(double[] y,int fs,double fmax){  
       this(y,fs,fmax,100,"log",16,3);  
    }  
    public BussowCWT(double[] y,int fs,double fmax, int maxNf){  
           this(y,fs,fmax,maxNf,"log",16,3);  
        }  
    public BussowCWT(double[] y,int fs,double fmax, int maxNf, int stepfac){  
           this(y,fs,fmax,maxNf,"log",stepfac,3);  
        }  
    public BussowCWT(double[] y,int fs,double fmax, int maxNf, int stepfac, int df0){  
           this(y,fs,fmax,maxNf,"log",stepfac,df0);  
        }  
    public BussowCWT(double[] y,int fs,double fmax, int maxNf, String linlog, int stepfac, int df0){  
